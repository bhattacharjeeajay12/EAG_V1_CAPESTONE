...
class SessionMemory:
    ...
    - Persist conversation state in JSON under memory\{agent_name}\{session_id}.json.
...
class SessionMemory:
    ...
    def __init__(self, agent_name: str, base_dir: Optional[str] = None):
        ...
        self.session_id = None
        self.session_path = None
        print(f"[Memory] Initialized for agent '{agent_name}' at {self.agent_dir}")
    ...
    def new_session(self, label: Optional[str] = None, config: Optional[Dict[str, Any]] = None) -> str:
        ...
        with open(session_file, "w", encoding="utf-8") as f:
            json.dump(session_data, indent=2, ensure_ascii=False, sort_keys=True, fp=f)

        print(f"[Memory] Created new session {self.session_id} for agent {self.agent_name}")
    ...
    def save(self, 
        ...
        :param perceptions_history: List of perception results
        ...
        session_data = {
            ...
            "perceptions_history": perceptions_history,
        ...
        print(f"[Memory] Saved session state to {snapshot_file}")
