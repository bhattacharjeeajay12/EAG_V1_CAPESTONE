...
class AgentBase(Protocol):
    # async def mandatory_slot_check(self, ctx: AgentContext) -> Optional[AgentOutput]: ...
    # async def non_mandatory_slot_check(self, ctx: AgentContext) -> Optional[AgentOutput]: ...
